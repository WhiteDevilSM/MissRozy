        ...
        await editable.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("⚡️ Open Link ⚡️", url=share_link)],
                 [InlineKeyboardButton("🔊ß⊕ts Channel", url="https://t.me/SM_updates_12"),
                  InlineKeyboardButton("🍿supp⊕rt gr⊕up", url="https://t.me/SM_Movies_Request")]]
            ),
            disable_web_page_preview=True
        )
        await bot.send_message(
